...
def parse_args(
    ...
    default_ray_batch_size=5000,
):
    parser = argparse.ArgumentParser()
    parser.add_argument("--conf", "-c", type=str, default='NeRRFsngp.conf')
    ...
    parser.add_argument(
        "--name", "-n", type=str, default='ball_ior_optim_trace_ior11', help="experiment name"
    )
    parser.add_argument(
        "--dataset_format",
        "-F",
    ...
    parser.add_argument(
        "--datadir", "-D", type=str, default='data/blender/transparent/ball', help="Dataset directory"
    )
    parser.add_argument(
        "--ray_batch_size",
        "-R",
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False, 
        help="trace to get refraction and reflection"
    )
