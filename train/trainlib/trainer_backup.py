...
class Trainer:
    def __init__(self, net, train_dataset, test_dataset, args, conf, device=None):
        ...
        self.num_epochs = conf.get_int("num_epochs", 4) #在此处修改训练的epoch数
    ...
    def start(self):
        ...
        for epoch in range(self.num_epochs):
            '''new_lr = self.lr_scheduler.get_last_lr()[0] if self.lr_scheduler is not None \
                else self.optim.param_groups[0]["lr"]
