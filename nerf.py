...
class NeRFRenderer(torch.nn.Module):
    ...
    def init_tet(self, mesh_path, geometry_name=None):
        ...
        try:
            print('----------------------')
            print('use learned mesh')
            print(mesh_path)
            print('----------------------')
            '''mesh = trimesh.load('data/learned_geo/bunny.obj')
            verts=mesh.vertices
            faces=mesh.faces
        ...
        #self.mesh=trimesh.load('ball.obj')
        #保存
    ...
    def trace_ray_mesh(
        ...
        fresnel_1 = self.Fresnel_term(n, in_dir, refr_dir, normals)#菲涅尔反射系数,[num_hit_ray,1]
        ...
        fresnel_2 = self.Fresnel_term(n_, in_dir_, refr_dir_, normals_)#菲涅尔反射系数,[num_hit_ray,1]
        ...
        fresnel_2=fresnel_1*fresnel_2_total
